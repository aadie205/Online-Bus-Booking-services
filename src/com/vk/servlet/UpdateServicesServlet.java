...
public class UpdateServicesServlet extends HttpServlet{
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
    	  ...
    	  if(c==null) {
    		  ...
    		  if(al.size()==0) {
    			  pw.print("<br>No Services available to Update. Please add a service...!<br><br> ");
    			  RequestDispatcher rd=req.getRequestDispatcher("Link.html");
				  rd.include(req, res);
    		  }else {
    			  ...
    			  RequestDispatcher rd=req.getRequestDispatcher("Link.html");
				  rd.include(req, res);
				  pw.print("<br><br><br><br>Please select service no to update details :<br>");
				  pw.print("----------------------------------------------------");
    			  al.forEach((k)->
    			  { 
    				 ...
    				 pw.print("<br><a href='Update.html'>"+bb.getServNo()+"</a>"+"&nbsp&nbsp");
